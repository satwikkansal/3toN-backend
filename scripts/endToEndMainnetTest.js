...
async function main() {
  ...
  const [owner_signer, participant_1_signer, participant_2_signer] = await hre.ethers.getSigners();

  // the superfluid object
  const sf  = await Framework.create({
    chainId:  networks[network]["suprfluidChainId"], // todo: fix this
  ...
  //   sender: "0x8a315E2850e3dBD3da7e57230dfdAf3ba3f8b6B2",
  //   receiver: "0xf457AEfc41f9e6C22AF28043a434345C1059182a",
  //   superToken: daiXAddress,
  // });

  // await deleteFlowOperation.exec(participant_1_signer);
  ...
  // start stream 
  let startTxn = await contract.start(streamId, rate, daiXAddress, streamName, 1000, 0, {gasLimit: 8000000});
  ...
  // let deleteFlowOperation = sf.cfaV1.deleteFlow({
  //   sender: "0xf457AEfc41f9e6C22AF28043a434345C1059182a",
  //   receiver: "0x8a315E2850e3dBD3da7e57230dfdAf3ba3f8b6B2",
  //   superToken: daiXAddress,
  // });

  // await deleteFlowOperation.exec(owner_signer);
  ...
  if (flowOperatorData.flowRateAllowance < streamData.rate) {
    console.log(`Sufficient permissions don't exist for participant 1. Getting them`)
